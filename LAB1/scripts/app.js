...
if (document.title === 'Home') {
    var welcomeMessage = "Welcome to my WEBD - Client Side website! I hope you enjoy browsing through the content :)";
    var welcomeDiv = document.getElementById("welcome-message");
    welcomeDiv.innerHTML = welcomeMessage;
} else if (document.title == "Product") {
    var interestingMessage = "For my first piece of media, I chose the new Batman movie starring everyones favourite sparkling vampire\
    ...
    My second piece of media is Mama Mia cause the classics don't die. I spent my entire childhood (and into my adult years) with Mia as\
    ...
    will forever make me feel 17 again. Lastly for my media choices, we have the new Elvis movie because holly molly Austin Butler is handsome...and ya know..sounds like elvis\
    ...
    var interestingDiv = document.getElementById("interest-message");
    interestingDiv.innerHTML = interestingMessage;
} else if (document.title == "Services") {
    var skillsMessage = "Hi, my name is Amelia Eric-Markovic and I am a computer programming and analysis student at Durham College in Oshawa, Ontario. I have a strong set of technical skills that I can offer to clients, including custom programming, web design, and data analysis.\
    ...
    var skillsDiv = document.getElementById("skills-message");
    skillsDiv.innerHTML = skillsMessage;
} else if (document.title == "About Us") {
    var aboutMessage = "I am 19 years old and the eldest child in my family with a younger brother.\
     I am also a proud owner of a shiatzu poodle mix named Michelangelo Pokémon Nenad Eric-Markovic.\
     I enjoy listening to music and podcasts, exploring smart home technology and experimenting with interior design.\
    ...
    var aboutDiv = document.getElementById("about-message");
