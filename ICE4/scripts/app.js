...
// functin to add the image next to the text
if ($("#speckled-excerpt")) {
    let aspImg = "<img class='asp-image' src='./images/asp.jpeg'>";
...
if ($("#btnRegSubmit")) {
    ...
    $("#btnRegSubmit").click(function (e) {
        ...
        (formValidation.validateFirst(unvalidated_user.firstName));
        // validate last name
        $("#last-group").children(".errorMessage").html
        (formValidation.validateLast(unvalidated_user.lastName));
        // validate  username
        $("#username-group").children(".errorMessage").html
        (formValidation.validateUsername(unvalidated_user.username));
